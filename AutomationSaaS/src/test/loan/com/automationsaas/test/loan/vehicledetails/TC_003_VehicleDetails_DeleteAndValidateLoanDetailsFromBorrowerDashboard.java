...
public class TC_003_VehicleDetails_DeleteAndValidateLoanDetailsFromBorrowerDashboard extends Base {
	...
	public void test() {
		...
		loanDetailsPage.clickVehicleDetailsDelete();
		loanDetailsPage.validateIfNoVehicleDetailsDisplayed("There is no Vehicle Detail to show");
	}
}