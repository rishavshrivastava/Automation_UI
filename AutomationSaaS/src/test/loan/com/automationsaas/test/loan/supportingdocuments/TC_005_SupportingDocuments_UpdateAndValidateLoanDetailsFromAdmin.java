...
public class TC_005_SupportingDocuments_UpdateAndValidateLoanDetailsFromAdmin extends Base {
	...
	public void updateBorrower() {
		...
		loanDetailsPage.previewDocument();
		Generics.refreshPage(driver);
		loanDetailsPage.clickSupportingDocument();
		loanDetailsPage.clickLoanApplicationDocumentAccordion();
		loanDetailsPage.clickCoApplicantDocumentAccordion();
		loanDetailsPage.clickReferenceDocumentAccordion();
		loanDetailsPage.downloadDocument();
		Generics.refreshPage(driver);
		loanDetailsPage.clickSupportingDocument();
		loanDetailsPage.clickLoanApplicationDocumentAccordion();
		loanDetailsPage.clickCoApplicantDocumentAccordion();
		loanDetailsPage.clickReferenceDocumentAccordion();
		loanDetailsPage.uploadDocument(png_upload_file_path);
		Generics.refreshPage(driver);
		loanDetailsPage.clickSupportingDocument();
		loanDetailsPage.clickLoanApplicationDocumentAccordion();
		loanDetailsPage.clickCoApplicantDocumentAccordion();
		loanDetailsPage.clickReferenceDocumentAccordion();
		loanDetailsPage.validateDocumentCount("Adhar Card", 4);
		Generics.refreshPage(driver);
		loanDetailsPage.clickSupportingDocument();
		loanDetailsPage.clickLoanApplicationDocumentAccordion();
		loanDetailsPage.clickCoApplicantDocumentAccordion();
		loanDetailsPage.clickReferenceDocumentAccordion();
		loanDetailsPage.deleteDocument();
		Generics.refreshPage(driver);
		loanDetailsPage.clickSupportingDocument();
		loanDetailsPage.clickLoanApplicationDocumentAccordion();
		loanDetailsPage.clickCoApplicantDocumentAccordion();
		loanDetailsPage.clickReferenceDocumentAccordion();
		loanDetailsPage.validateDocumentCount("Adhar Card", 3);
		...
		loanApplicationSupportingDocumentsDocumentName.add("PNGFile.png, JPGFile.jpg, TextFile.txt");
