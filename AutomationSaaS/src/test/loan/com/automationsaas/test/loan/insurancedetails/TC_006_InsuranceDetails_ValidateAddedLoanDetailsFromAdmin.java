...
public class TC_006_InsuranceDetails_ValidateAddedLoanDetailsFromAdmin extends Base {
	...
	public void updateBorrower() {
		...
		insuranceDetails_1.add("TATA AIG");
		insuranceDetails_1.add("50000.00");
		insuranceDetails_1.add("Credit");
		insuranceDetails_1.add("test");
