...
public class TC_011_InsuranceDetails_AddAndValidateLoanDetailsFromAdmin extends Base {
	...
	public void updateBorrower() {
		...
		insuranceDetails_1.add("MAX");
		insuranceDetails_1.add("500000.00");
