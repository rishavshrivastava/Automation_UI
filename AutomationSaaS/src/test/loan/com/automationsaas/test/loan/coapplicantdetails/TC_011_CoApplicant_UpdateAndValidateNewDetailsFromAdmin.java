...
public class TC_011_CoApplicant_UpdateAndValidateNewDetailsFromAdmin extends Base {
	...
	public void updateBorrower() {
		...
		coApplicantDetails.add("DNewUpdtAdmin");
		coApplicantDetails.add("SNewUpdtadmin");
		coApplicantDetails.add("divya.s+newupdateadmin@perfios.com");
		coApplicantDetails.add("new updteFrm admin");
		coApplicantDetails.add("Admin");
