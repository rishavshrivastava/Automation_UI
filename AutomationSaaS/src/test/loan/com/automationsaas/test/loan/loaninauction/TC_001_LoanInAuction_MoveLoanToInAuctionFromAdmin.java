...
public class TC_001_LoanInAuction_MoveLoanToInAuctionFromAdmin extends Base {

	@Test(priority = 9, retryAnalyzer = RetryAnalyzer.class, groups={"TC_20_MoveLoanToInAuction.updateBorrower"})
	public void updateBorrower() {
		...
		loanDetailsPage.clickCheckListAccordion();
		loanDetailsPage.clickChecklistCheckbox();
		loanDetailsPage.selectStatus("In Auction");
		loanDetailsPage.validateLoanStatus("In Auction");
	}
}
