...
public class TC_007_OtherLoanDetails_UpdateAndValidateLoanDetailsFromBorrowerDashboard extends Base {
	...
	public void test() {
		...
		otherLoanDetails.add("75000");
		otherLoanDetails.add("85000");
		otherLoanDetails.add("ICICI");
		...
		ArrayList<String> updatedOtherLoanDetails = new ArrayList<String>();
		updatedOtherLoanDetails.add("Car");
		updatedOtherLoanDetails.add("75000");
		updatedOtherLoanDetails.add("85000");
		updatedOtherLoanDetails.add("ICICI");
		updatedOtherLoanDetails.add("Testing");
		for(int i=0; i<updatedOtherLoanDetails.size();i++) {
			loanDetailsPage.validateOtherLoanDetails(i, updatedOtherLoanDetails.get(i));
		}
	}
}
