...
public class TC_014_OtherLoanDetails_ValidateUpdatedLoanDetailsFromBorrowerDashboard extends Base {
	...
	public void test() {
		...
		othertherLoanDetails.add("Bike");
		othertherLoanDetails.add("50000.00");
		othertherLoanDetails.add("55000.00");
		othertherLoanDetails.add("ICICC");
		othertherLoanDetails.add("Test");
