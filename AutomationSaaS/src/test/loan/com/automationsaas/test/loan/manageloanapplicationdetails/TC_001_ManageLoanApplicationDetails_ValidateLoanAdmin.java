...
public class TC_001_ManageLoanApplicationDetails_ValidateLoanAdmin extends Base {
	...
	public void updateBorrower() {
		...
		loanDetailsPage.clickManageLoanApplicationDetailsAccordion();

		ArrayList<String> manageLoanDetails = new ArrayList<String>();
		manageLoanDetails.add("200,000");
		manageLoanDetails.add("9 %");
		manageLoanDetails.add("12");
		for (int i = 0; i < manageLoanDetails.size(); i++) {
			loanDetailsPage.validateManageLoanApplicationDetails(i, manageLoanDetails.get(i));
		}
	}
}
