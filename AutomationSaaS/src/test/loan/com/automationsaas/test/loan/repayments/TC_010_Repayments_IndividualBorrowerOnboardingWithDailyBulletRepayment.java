...
public class TC_010_Repayments_IndividualBorrowerOnboardingWithDailyBulletRepayment extends Base {
	...
	public void validateIndividualBorrowerOnboarding() {
		...
		ReadWriteExcel.putData(excel_path, borrower_sheet_name, 1, 5, individualEmailId);
		...
		applyForLoanPage.selectLoanProduct("Medical");
		...
		applyForLoanPage.selectLoanRepaymentType("Daily Bullet Repayment");
		try {
			Thread.sleep(2000);
		} catch (InterruptedException e) {
			e.printStackTrace();
		}
		applyForLoanPage.selectTenure("30 Days");
		...
		supportingDocumentsPage.uploadDocument("Pan Card", png_upload_file_path);
		supportingDocumentsPage.uploadDocument("Address Proof", png_upload_file_path);
		...
		ReadWriteExcel.putData(excel_path, borrower_sheet_name, 2, 5, borrowerId);
		...
		ReadWriteExcel.putData(excel_path, borrower_sheet_name, 3, 5, loanId);
