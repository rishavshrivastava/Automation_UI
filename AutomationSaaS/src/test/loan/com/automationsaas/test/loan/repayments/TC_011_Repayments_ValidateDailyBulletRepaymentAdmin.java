...
public class TC_011_Repayments_ValidateDailyBulletRepaymentAdmin extends Base {
	...
	public void validateRepayment() {
		...
		String loanId = ReadWriteExcel.getData(excel_path, borrower_sheet_name, "Individual Borrower Loan ID").get(5);
		...
		PrintDates.printRepaymentDates(driver, "Daily Bullet Repayment", 12, excel_path, repayments_sheet_name);
		...
		totalinterestamount.add("Rs1,479");
		...
		System.out.println(serialno.size());
