package com.automationsaas.test.loan.borrowerquestiongroup;
...
public class TC_002_BorrowerQuestionGroup_ValidateLoanFromAdmin extends Base {
	...
	public void updateBorrower() {
		...
		loanDetailsPage.clickCreditAnswers();
		loanDetailsPage.clickBorrowerQuestionGroupAccordion();

		ArrayList<String> borrowerQuestionGroup = new ArrayList<String>();
		borrowerQuestionGroup.add("Indian");
		borrowerQuestionGroup.add("50000");
		for (int i = 0; i < borrowerQuestionGroup.size(); i++) {
			loanDetailsPage.validateBorrowerQuestionGroup(i, borrowerQuestionGroup.get(i));
		}
	}
}