...
public class TC_001_LoanReject_RejectLoanApplication extends Base {
	...
	public void updateBorrower() {
		...
		loanDetailsPage.selectStatus("Application Rejected");
		loanDetailsPage.validateLoanStatus("Application Rejected");
	}
}
