...
public class TC_003_OtherLoanDetails_DeleteAndValidateLoanDetailsFromBorrowerDashboard extends Base {
	...
	public void test() {
		...
		//Reference Details delete code needs to be implemented
		
		loanDetailsPage.clickOtherLoanDetailsDelete();
