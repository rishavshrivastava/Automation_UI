...
public class TC_010_CoApplicant_ValidateUpdatedNewDetailsFromAdmin extends Base {
	...
	public void updateBorrower() {
		...
		addedCoApplicantDetails_2.add("DNewUpdateBor SNewUpdateBor");
		addedCoApplicantDetails_2.add("divya.s+newupdatebor@perfios.com");
		addedCoApplicantDetails_2.add("new updteFrm Dshbrd");
		addedCoApplicantDetails_2.add("Testing");
