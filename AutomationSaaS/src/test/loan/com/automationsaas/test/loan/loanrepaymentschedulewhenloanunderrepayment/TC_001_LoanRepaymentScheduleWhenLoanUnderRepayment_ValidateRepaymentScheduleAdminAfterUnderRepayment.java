package com.automationsaas.test.loan.loanrepaymentschedulewhenloanunderrepayment;
...
public class TC_001_LoanRepaymentScheduleWhenLoanUnderRepayment_ValidateRepaymentScheduleAdminAfterUnderRepayment extends Base {
	...
	public void validateRepayment() {
		...
		searchedLoan.add("Under Repayment");
		...
		loanApplicationsPage.clickLoanId();
				...
				repaymentpayment.add("- Select One -");
				repaymentpayment.add("Pending");
				repaymentpayment.add("Pending");
				repaymentpayment.add("Pending");
				repaymentpayment.add("Pending");
				repaymentpayment.add("Pending");
				...
				paymentdate.add(Generics.getCurrentDate());
				paymentdate.add("-");
				paymentdate.add("-");
				paymentdate.add("-");
				paymentdate.add("-");
				...
				for (int i = 0; i < serialno.size(); i++) {
					loanDetailsPage.validateRepaymentTableAfterDisbursal(i, serialno.get(i), repaymentdate.get(i), principal.get(i),
