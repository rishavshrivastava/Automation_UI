...
public class TC_002_InvestorContract_ValidateIndividualInvestorAdmin extends Base {
	...
	public void validateInvestor() {
		...
		investorDetailsPage.validateIfNoContractDisplayed("There is no Contract Details to be displayed.");
	}
}
