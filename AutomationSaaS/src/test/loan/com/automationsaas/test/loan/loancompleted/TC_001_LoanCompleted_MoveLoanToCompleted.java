package com.automationsaas.test.loan.loancompleted;
...
public class TC_001_LoanCompleted_MoveLoanToCompleted extends Base {
	...
	public void updateBorrower() {
		...
		loanDetailsPage.selectStatus("Completed");
		loanDetailsPage.validateLoanStatus("Completed");
	}
}
