...
public class TC_013_InsuranceDetails_UpdateAndValidateLoanDetailsFromAdmin extends Base {
	...
	public void updateBorrower() {
		...
		insuranceDetails.add("NIVA");
		insuranceDetails.add("50000");
		insuranceDetails.add("Bank");
		insuranceDetails.add("Tester");
		...
		insuranceDetails_1.add("NIVA");
		insuranceDetails_1.add("50000.00");
		insuranceDetails_1.add("Bank");
		insuranceDetails_1.add("Tester");
