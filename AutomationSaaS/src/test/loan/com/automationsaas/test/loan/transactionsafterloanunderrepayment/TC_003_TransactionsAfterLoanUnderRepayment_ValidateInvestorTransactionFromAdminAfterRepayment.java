...
public class TC_003_TransactionsAfterLoanUnderRepayment_ValidateInvestorTransactionFromAdminAfterRepayment extends Base {
	...
	public void validateInvestor() {
		...
		investorDetailsPage.validateAccountBalance("Rs1,300,000");
		investorDetailsPage.validateInvestorEmailId(investorEmailId);
		investorDetailsPage.clickTransactions();
		investorDetailsPage.clickCompletedTransactionAccordion();
		investorDetailsPage.validateCompletedTransactions(1900000, 4100000);
	}
}
