package com.automationsaas.test.loan.payemi;
...
public class TC_001_PayEMI_RepayEMI extends Base {
	...
	public void updateBorrower() {
		...
		loanDetailsPage.validateLoanStatus("Under Repayment");
		
		String amountToBeRepaid = loanDetailsPage.storeAmountToBeRepaid();
		ReadWriteExcel.putData(excel_path, repayments_sheet_name, 21, 1, amountToBeRepaid);
		
		loanDetailsPage.clickLoanRepaymentScheduleAccordion();
		
		for(int i=0;i<12;i++) {
			loanDetailsPage.payRepayments(i, "yes", "Paid", "PAID");
		}
	}
}
