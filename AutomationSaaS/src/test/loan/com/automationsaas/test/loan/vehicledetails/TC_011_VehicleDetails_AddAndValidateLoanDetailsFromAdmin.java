...
public class TC_011_VehicleDetails_AddAndValidateLoanDetailsFromAdmin extends Base {
	...
	public void updateBorrower() {
		...
		addedVehicleDetails.add("DL0980");
		addedVehicleDetails.add("Testing");
