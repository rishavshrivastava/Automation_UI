...
public class TC_006_Repayments_ValidateFlatRateRepaymentBorrowerDashboard extends Base {
	...
	public void test() {
		...
		String username = ReadWriteExcel.getData(excel_path, borrower_sheet_name, "Individual Borrower MailID").get(3);
		String password = ReadWriteExcel.getData(excel_path, borrower_sheet_name, "Individual Borrower MailID").get(3);
