...
public class TC_014_CoApplicant_ValidateDeletedNewDetailsFromDashboard extends Base {
	...
	public void test() {
		...
		coApplicantDetails_2.add("DAdminSec SAdminSec");
		coApplicantDetails_2.add("divya.s+AdminSec@perfios.com");
		coApplicantDetails_2.add("AddedSec from admin");
		coApplicantDetails_2.add("Development sec");
