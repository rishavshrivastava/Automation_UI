...
public class TC_009_InsuranceDetails_DeleteAndValidateLoanDetailsFromAdmin extends Base {
	...
	public void updateBorrower() {
		...
		loanDetailsPage.clickInsuranceDetailsDelete("Yes");
		
		loanDetailsPage.validateIfNoInsuranceDetailsDisplayed("There is no insurance Detail To show");
	}
}