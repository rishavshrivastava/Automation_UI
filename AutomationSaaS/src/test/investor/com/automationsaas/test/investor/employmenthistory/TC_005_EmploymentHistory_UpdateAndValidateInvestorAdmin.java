...
public class TC_005_EmploymentHistory_UpdateAndValidateInvestorAdmin extends Base {
	...
	public void validateInvestor() {
		...
		ArrayList<String> investorEmploymentHistoryInfo = new ArrayList<String>();
		investorEmploymentHistoryInfo.add("Testing");
		investorEmploymentHistoryInfo.add("Perfios");
		investorEmploymentHistoryInfo.add("Fintech");
		investorEmploymentHistoryInfo.add("Testing");
		for (int i = 0; i < investorEmploymentHistoryInfo.size(); i++) {
			investorDetailsPage.editEmploymentHistoryInfo(i, investorEmploymentHistoryInfo.get(i));
		}
		investorDetailsPage.clickUpdateEmploymentHistoryInfo();

		// Updated Employment History
		Generics.refreshPage(driver);
		investorDetailsPage.clickEmploymentHistoryInfoAccordion();
		ArrayList<String> employmentHistoryInfo = new ArrayList<String>();
		employmentHistoryInfo.add("Testing");
		employmentHistoryInfo.add("Perfios");
