...
public class TC_001_AddressDetails_DeleteAndValidateOldInvestorDetailsAdmin extends Base {

	@Test(retryAnalyzer = RetryAnalyzer.class)
	public void validateInvestor() {
		String file = TC_001_AddressDetails_DeleteAndValidateOldInvestorDetailsAdmin;
		
		String addressName = Generics.jsonParser(file, "addressName");
