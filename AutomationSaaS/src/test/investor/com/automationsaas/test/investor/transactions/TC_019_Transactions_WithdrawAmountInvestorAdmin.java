...
public class TC_019_Transactions_WithdrawAmountInvestorAdmin extends Base {
	...
	public void test() {
		...
		investorDetailsPage.validateAccountBalance("Rs2,995,000");
		investorDetailsPage.validateInvestorEmailId(investorEmailId);
		investorDetailsPage.clickWithdraw();
		investorDetailsPage.enterWithdrawAmount("5000");
		investorDetailsPage.clickWithdrawButton();
		investorDetailsPage.validateAccountBalance("Rs2,990,000");
	}
}
