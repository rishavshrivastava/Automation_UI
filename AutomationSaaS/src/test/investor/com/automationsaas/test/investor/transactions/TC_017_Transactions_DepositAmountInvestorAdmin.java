...
public class TC_017_Transactions_DepositAmountInvestorAdmin extends Base {
	...
	public void test() {
		...
		investorDetailsPage.validateAccountBalance("Rs1,495,000");
		investorDetailsPage.validateInvestorEmailId(investorEmailId);
		investorDetailsPage.clickDeposit();
		investorDetailsPage.enterDepositAmount("1500000");
		investorDetailsPage.clickDepositButton();
