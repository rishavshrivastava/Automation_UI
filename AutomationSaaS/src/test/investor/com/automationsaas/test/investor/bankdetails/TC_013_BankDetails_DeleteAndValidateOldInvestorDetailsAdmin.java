...
public class TC_013_BankDetails_DeleteAndValidateOldInvestorDetailsAdmin extends Base {
	...
	public void validateInvestor() {
		...
		investorDetailsPage.clickBankDetailsAccordion();
     	...
     	investorDetailsPage.clickBankDetailsDelete(0);
		investorDetailsPage.noBankDetailsMessage("There is no Bank Details to be displayed.");
