...
public class TC_006_InvestorDetails_ValidateUpdatedInvestorFromDashboard extends Base {
	...
	public void test() {
		...
		basicProfile.add("11/11/1995");
		basicProfile.add("Male");
		basicProfile.add("Unmarried");
		basicProfile.add(phoneNumber);
		basicProfile.add("xxxxxxxx2354");
		basicProfile.add("xxxxxx542R");
