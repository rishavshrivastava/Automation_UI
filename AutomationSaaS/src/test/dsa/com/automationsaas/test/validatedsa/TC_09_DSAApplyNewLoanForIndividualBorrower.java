...
public class TC_09_DSAApplyNewLoanForIndividualBorrower extends Base {

	@Test (retryAnalyzer = RetryAnalyzer.class)
	public void validateApplyNewLoanForIndividualBorrower() throws InterruptedException {
		...
		String individualEmailId = "chandrasekar.y+dsaindborrower" + Generics.generateTimeStamp() + "@perfios.com";
		borrowerRegistrationPage.enterborrowerEmail(individualEmailId);
...
//		}
		...
		detailsPage.enterPersonalAddress("Line1", "Line2", "Line3", "Sub District", "District", "Karnataka", "City",
				"Country", "785452", "2005", "Sep", "3", "Double story house", "Address");
		detailsPage.enterAddressOne("Line1", "Line2", "Line3", "Sub District", "District", "Karnataka", "City",
				"Country", "785452", "2005", "Sep", "3", "Double story house", "Address One");
		detailsPage.enterAddressTwo("Line1", "Line2", "Line3", "Sub District", "District", "Karnataka", "City",
				"Country", "785452", "2005", "Sep", "3", "Double story house", "Address Two");
		detailsPage.enterAddressThree("Line1", "Line2", "Line3", "Sub District", "District", "Karnataka", "City",
				"Country", "785452", "2005", "Sep", "3", "Double story house", "Address Three");
		...
		employmentDetailsPage.enterAddress("Line1", "Line2", "Line3", "Bengaluru", "Bangalore", "Karnataka",
		...
		Generics.scrollPage(driver, -1800);
		...
		supportingDocumentsPage.uploadDocument("Pan Card", text_upload_file_path);// pdf_upload_file_path
		...
		existingBorrowerPage.fillEmailFilter(individualEmailId);
		existingBorrowerPage.clickOnSearch();
		String dsaborrowerId = existingBorrowerPage.getBorrowerId();
		System.out.println("Individual Type Borrower ID Created : " + dsaborrowerId);
		ReadWriteExcel.putData(excel_path, dsa_sheet_name, 5, 1, individualEmailId);
		ReadWriteExcel.putData(excel_path, dsa_sheet_name, 6, 1, dsaborrowerId);
		...
		ReadWriteExcel.putData(excel_path, dsa_sheet_name, 7, 1, activeLoanID);
