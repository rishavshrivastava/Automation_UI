...
public class TC_19_WithdrawAmountDSAFromAdminSide extends Base {
	...
	public void transactionFromAdminSide() {
		...
		dsaDetailsPage.clickWithdraw();
		dsaDetailsPage.enterWithdrawAmount("5000");
		dsaDetailsPage.clickWithdrawButton();
		dsaDetailsPage.validateAccountBalance("Rs20,000");
	}
}
