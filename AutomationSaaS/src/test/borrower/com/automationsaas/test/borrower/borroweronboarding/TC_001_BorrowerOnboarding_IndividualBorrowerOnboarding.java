...
public class TC_001_BorrowerOnboarding_IndividualBorrowerOnboarding extends Base {
	...
	public void validateIndividualBorrowerOnboarding() {
		...
		ReadWriteExcel.putData(excel_path, borrower_sheet_name, 19, 1, landlineNumber);
		...
		Generics.refreshPage(driver);
		supportingDocumentsPage.uploadDocument("Adhar Card", jpg_upload_file_path);
		Generics.refreshPage(driver);
		supportingDocumentsPage.validateUploadedDocument("Adhar Card", 3);
		Generics.refreshPage(driver);
		...
		borrowerDashboardPage.validateFundedPercentage("%");
		...
		loanDetailsPage.validateLoanRepaymentTable();
		loanDetailsPage.clickQuestionsAccordion();
		loanDetailsPage.validateQuestions("There is No Question to be Displayed.");
		loanDetailsPage.clickQuestionGroupAccordion();
		loanDetailsPage.validateQuestionGroups("Indian", "50000");
