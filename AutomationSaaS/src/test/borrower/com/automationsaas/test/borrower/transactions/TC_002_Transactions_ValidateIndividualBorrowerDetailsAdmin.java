...
public class TC_002_Transactions_ValidateIndividualBorrowerDetailsAdmin extends Base {
	...
	public void validateBorrowerDetails() {
		...
		borrowerDetailsPage.validateCompletedTransactionWhenNoTransaction("There is no transaction to be displayed.");
	}
}
