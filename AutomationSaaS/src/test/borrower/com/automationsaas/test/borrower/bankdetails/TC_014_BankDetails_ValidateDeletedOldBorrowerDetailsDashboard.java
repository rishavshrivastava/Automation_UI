...
public class TC_014_BankDetails_ValidateDeletedOldBorrowerDetailsDashboard extends Base {
	...
	public void test() {
		...
		profilePage.validateIfNoBankDetails("There is no Bank Details to be displayed.");
	}
}
