...
public class TC_002_EmploymentHistoryInfo_ValidateIndividualBorrowerDetailsAdmin extends Base {
	...
	public void validateBorrowerDetails() {
		...
		borrowerDetails.add("Technology");
		borrowerDetails.add("QA");
		borrowerDetails.add("Per785");
