...
public class TC_016_BankDetails_ValidateNewAddedBorrowerDetailsAdmin extends Base {
	...
	public void updateBorrower() {
		...
		bankDetails_validate.add("8545215635");
		bankDetails_validate.add("Savings");
		bankDetails_validate.add("SBI");
		bankDetails_validate.add("SBIN0323");
		bankDetails_validate.add("Rishav");
		
		for (int j = 0; j < bankDetails_validate.size(); j++) {
			borrowerDetailsPage.validateBankDetails(0, j, bankDetails_validate.get(j));
		}
	}
}
