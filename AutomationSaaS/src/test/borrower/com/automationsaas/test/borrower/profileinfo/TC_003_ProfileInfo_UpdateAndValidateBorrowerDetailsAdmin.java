...
public class TC_003_ProfileInfo_UpdateAndValidateBorrowerDetailsAdmin extends Base {
	...
	public void updateBorrower() {
		...
		ArrayList<String> updateProfileInfoDetails = new ArrayList<String>();
		updateProfileInfoDetails.add("1 Year");
		updateProfileInfoDetails.add("Contractors");
		updateProfileInfoDetails.add("100000");
		for(int i=0; i<updateProfileInfoDetails.size(); i++) {
			borrowerDetailsPage.editProfileInfo(i, updateProfileInfoDetails.get(i));
		}
		borrowerDetailsPage.updateProfileInfo();
		...
		borrowerDetails.add("1 Year");
		borrowerDetails.add("Contractors");
		borrowerDetails.add("100,000");
