...
public class TC_021_Transactions_WithdrawAmountBorrowerAdmin extends Base {
	...
	public void transactionFromAdminSide() {
		...
		borrowerDetailsPage.validateAccountBalance("Rs1,510,000");
		
		borrowerDetailsPage.clickWithdraw();
		borrowerDetailsPage.enterWithdrawAmount("5000");
		borrowerDetailsPage.clickWithdrawButton();
		borrowerDetailsPage.validateAccountBalance("Rs1,505,000");
	}
}
