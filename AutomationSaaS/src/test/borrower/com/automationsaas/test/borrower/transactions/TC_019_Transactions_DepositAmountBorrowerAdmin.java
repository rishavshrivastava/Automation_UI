...
public class TC_019_Transactions_DepositAmountBorrowerAdmin extends Base {
	...
	public void transactionFromAdminSide() {
		...
		borrowerDetailsPage.validateAccountBalance("Rs1,495,000");
		
		borrowerDetailsPage.clickDeposit();
		borrowerDetailsPage.enterDepositAmount("15000");
