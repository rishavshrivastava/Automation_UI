...
public class TC_026_BorrowerDetails_ValidateDeletedNewDetailsFromDashboard extends Base {
	...
	public void test() {
		...
		for (int j = 0; j < addedshareholderdetails_0.size(); j++) {
			companyRepresentativePage.validateShareHolderDetails(0, j, addedshareholderdetails_0.get(j));
		}
	}
}
