...
public class TC_008_AddressDetails_ValidateNewlyAddedAddressFromAdmin extends Base {
	...
	public void updateBorrower() {
		...
		addressDetails.add("Line132");
		addressDetails.add("Line243");
		addressDetails.add("Line376");
		addressDetails.add("Indore");
		addressDetails.add("Karnataka");
		addressDetails.add("534597");
