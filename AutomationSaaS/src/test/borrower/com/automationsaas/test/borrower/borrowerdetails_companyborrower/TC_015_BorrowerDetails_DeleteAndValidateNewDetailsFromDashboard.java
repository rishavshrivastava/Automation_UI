...
public class TC_015_BorrowerDetails_DeleteAndValidateNewDetailsFromDashboard extends Base {
	...
	public void test() {
		...
		for (int j = 0; j < addedshareholderdetails_0.size(); j++) {
			companyRepresentativePage.validateShareHolderDetails(shareholderDetailsCount - 1, j,
					addedshareholderdetails_0.get(j));
		}
	}
}
