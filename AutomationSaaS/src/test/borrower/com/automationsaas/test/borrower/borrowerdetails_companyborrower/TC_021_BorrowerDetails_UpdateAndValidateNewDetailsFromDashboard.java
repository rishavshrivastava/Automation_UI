...
public class TC_021_BorrowerDetails_UpdateAndValidateNewDetailsFromDashboard extends Base {
	...
	public void test() {
		...
		companyRepresentativePage.enterShareHolderMobileNumber("9876543009");
		companyRepresentativePage.enterShareHolderDob("1999", "Apr", "19");
		...
		companyRepresentativePage.enterShareHolderIdentityNumberTwo("TYPER1001B");
		companyRepresentativePage.enterShareHolderDateOfAppointment("2017", "Feb", "26");
		...
		companyRepresentativePage.enterShareHolderAddressOne("SHLine1 borrower", "SHLine2 borrower", "SHLine3 borrower",
				...
				"SHCountry borrower", "125010", "2010", "Jun", "24", "Staff Residence", "Address Two");
		...
		addedshareholderdetails_1.add("TYPER1001B");
		addedshareholderdetails_1.add("divya.s+borrower@perfios.com");
		addedshareholderdetails_1.add("Indians borrower");
		addedshareholderdetails_1.add("26/02/2017");
		addedshareholderdetails_1.add("9876543009");
		addedshareholderdetails_1.add("19/04/1999");
		addedshareholderdetails_1.add(
				"SHLine1 borrower, SHLine2 borrower, SHLine3 borrower, SHCity borrower, Uttar Pradesh, 125010, SHCountry abc");
		addedshareholderdetails_1.add("Tester borrower");
		addedshareholderdetails_1.add("276528359000");
